...
class Movements(ttk.Frame):
    ...
    def __init__(self, parent, **kwargs):
        ...
        self.canvas.config(width=881,height= 180)
        self.canvas.grid_propagate(0)
        self.verticaScrollbar.config(command=self.canvas.yview)

        self.frame = Frame(self.canvas, width=881, height= 180)
    ...
    def printHeaders(self): 
        #pintando cabeceras   
        for i in range (0, 7):
            self.lblDisplay = ttk.Label(self, text=self._head[i], font='verdana, 11', width = 15, background ='white', borderwidth=1, anchor=CENTER)
            self.lblDisplay.grid(row=0, column=i, padx=2, pady=5)
    ...
    def printMovements(self): 
        ...
        for movement in self.movements:
            ...
            while i <=6:
                ...
                self.lblDisplay = ttk.Label(self.frame, text=movement[i], font='Verdana, 10',width= 16, padding=6, background ='white', foreground ='black', borderwidth=1, relief=GROOVE, anchor=CENTER)
...
class NewTransaction(ttk.Frame):
    def __init__(self, parent, **kwargs):
        ...
        ttk.Label(self, text='Nueva transacción', width=20,font="Verdana, 16", foreground='#191919', anchor=CENTER).grid(column=0,row=0, columnspan=2, ipadx=8, padx=10, pady=20, sticky=W)
        ttk.Label(self, text='From:', width=_lblwidth, font=font, anchor=E).grid(column=0, row=1, padx=12, pady=_pady)
...
class Results(ttk.Frame):
    def __init__(self, parent, **kwargs):
        ttk.Frame.__init__(self, height=kwargs['height'],width = kwargs['width'], borderwidth=1, relief= GROOVE)
        
        ttk.Label(self, text='Tu inversión', font="Verdana,16", anchor=E, width =_lblwidth).grid(column=0,row =3, ipady=10, ipadx=0, pady=3, padx=5)
...
class Simulador(ttk.Frame):
    def __init__(self, parent):
        ttk.Frame.__init__(self, width="990", height="630") 
        ...
        self.Button1 = ttk.Button(self, text ='+ Nueva transación', command=lambda: self.buttonSimulador(), width=20)
